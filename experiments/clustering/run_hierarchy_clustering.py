...
###### It will run for two cases. case 1  using all 18 features and case 2 with 9 features
###### It runs for all the three data sets and the labels are set manually for the confusion matrix plot so that it matched the plots in the paper.
cases =[1,2]
for case in cases:
    ...
    for z in range(0,3):
        ...
        for optimal_k in optimal_ks:    
            ...
            print(labels)
            #labels = sorted(set(true_labels + pred_labels))  # Get sorted unique labels
            if z==0 and optimal_k==9 and case==1:
                labels=['1', '2', '7_9',  '8', '3', '4', '5', '6']
            elif z==0 and optimal_k==15 and case==1:
                labels=['1', '2', '14', '13', '3', '4_5_6_12', '7', '8_9_10', '11_15']
            elif z==2 and optimal_k==9 and case==1:
                labels=['1', '2', '4', '5', '6', '3_8', '7_9']
            elif z==2 and optimal_k==14 and case==1:
                labels= ['1', '2_3', '5_8', '6_10_11_13_14', '4_7_9_12'] 

            if z==0 and optimal_k==9 and case==2:
                labels = ['1', '2', '9', '6' ,'3', '4', '5_7_8'] 
            elif z==0 and optimal_k==15 and case==2:
                labels=['1', '2', '3',  '14', '15', '5', '4_7', '6_8', '9_10_12_13' ]
            elif z==2 and optimal_k==9 and case==2:
                labels=['7', '8', '9', '5_6', '4','1_3', '2' ]
            elif z==2 and optimal_k==14 and case==2:
                labels= ['12', '13', '14','9_10_11', '8', '1_7', '2_6', '3_4_5' ]
            ...
            res_cm = -(conf_matrix.T / conf_matrix.sum(1)).T
            ...
            im = py.imshow(res_cm, cmap='RdBu', vmin=-1., vmax=1.)
            
            cbar = py.colorbar(fraction=0.035)
            cbar.ax.tick_params(labelsize=18)
            # Remove ticks and set tick params
            py.xticks([])
            py.yticks([])
